...
namespace MoreRealisticLaundering.Util
{
    public static class ColorUtil
    {
            ...
            return new Dictionary<string, Color32>
        {
            ...
            { "Gold", new Color(255, 215, 0, byte.MaxValue) },
            { "Black", new Color(0, 0, 0, byte.MaxValue) },
            { "White", new Color(255, 255, 255, byte.MaxValue) },
            { "Red", new Color(255, 0, 0, byte.MaxValue) },
            { "Green", new Color(0, 255, 0, byte.MaxValue) },
            { "Blue", new Color(0, 0, 255, byte.MaxValue) },
            { "Pink", new Color(255, 192, 203, byte.MaxValue) }
        };
        }
